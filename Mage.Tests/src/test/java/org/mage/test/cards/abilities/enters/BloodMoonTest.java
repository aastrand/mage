...
public class BloodMoonTest extends CardTestPlayerBase {
    ...
    // Grassland has to enter the battlefield untapped, because
    // the Blood Moon prevents ETB Replacement Effects
    @Test
    public void testBloodMoonPreventsETBReplacementEffects() {
        // Blood Moon   2R
        // Enchantment
        ...
        Assert.assertEquals("Grasslands is tapped but should not be since we ignore the replacement effect", false, grassland.isTapped());

    }

    @Test
    public void testBloodMoonShockLand() throws FileNotFoundException, GameException {
        final String land = "Steam Vents";
        // Blood Moon   2R
        // Enchantment
        // Nonbasic lands are Mountains
        addCard(Zone.BATTLEFIELD, playerA, "Blood Moon");
        ...
        // Make sure we didn't have to shock ourselves
        assertLife(playerA, 20);
        assertLife(playerB, 20);

        // Check that the land is untapped
        Permanent untappedLand = getPermanent(land, playerA.getId());
        Assert.assertEquals(untappedLand + " is tapped but should not be since we ignore the replacement effect", false, untappedLand.isTapped());

    }

    @Test
    public void testBloodMoonPreventsETBReplacementAndTriggeredEffects() {
        // Blood Moon   2R
        // Enchantment
        // Nonbasic lands are Mountains
        addCard(Zone.BATTLEFIELD, playerA, "Blood Moon");
        ...
        // Check that the land is untapped
        Permanent crossroads = getPermanent("Kabira Crossroads", playerA.getId());
        Assert.assertEquals("Kabira Crossroads is not untapped but is has to be since we ignore the ETB replacement effect", false, crossroads.isTapped());
